...
<head>
	...
	<meta charset="utf-8">
	<title>Admin panel - Groups/Tabs management</title>
    ...
    <div class="panel panel-default">
		...
		<div class="panel-body">
            <ul>
                ...
                <li>If the index position is <strong>set to 99</strong>, the tab will appear as the last one.</li>
            </ul>
        </div>
    </div>
</div>
