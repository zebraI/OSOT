...
<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="search.php" class="navbar-left"><img src="http://localhost/osot/pictures/thinxtra_logo.png"></a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="http://localhost/osot/search.php">Search</a></li>
                <li><a href="http://localhost/osot/reporting.php">Reporting</a></li>
				<li><a href="http://localhost/osot/data_entry.php?thinxtra_site_id=new&tab=
				<?php
				...
				?>">Data entry</a></li>
				<li><a href="http://localhost/osot/templates_index.php">Dashboard</a></li>
            </ul>
			<ul class="nav navbar-nav navbar-right">
			
			<?php if ($_SESSION['user_groups'][0] == 'admin') :?>
				<li><a href="http://localhost/osot/admin.php">Admin</a></li>
			<?php else :?>
				<li><a href="http://localhost/osot/user_settings.php">Settings</a></li>
			<?php endif;?>
			
				<li><a href="http://localhost/osot/model/connection_process/process_logout.php">Logout</a></li>
            </ul>
        </div>
    </div>
</div>
