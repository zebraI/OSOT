...
//-------------------------------------------------------------------------------
//Check if the site_id is unique
// function check_unique_site_id($mysqli, $xml){
	// Create an error message array
	// $messages = array();
	
	// Get the site id
	// $thinxtra_site_id = $xml->thinxtra_site_id;
	
	// SQL statement to get the number of sites with the id
	// $sql = "SELECT idSites FROM sites WHERE thinxtraId=?";
	...
	// Indicate which are the parameters to put into the request
		...
		// if (! $stmt->execute()) {
			// $message = "ERROR : site database - Problem when trying to check if the thinxtra site id is already existing.";
			// array_push($messages, $message);
		// }
		// else {
			// $stmt->bind_result($table_site_id);
			// $row_number = $mysqli->affected_rows;
			// $stmt->close();
		// }
	// }
	// else {
		// $message = "ERROR : site database - Problem when preparing request to check if the thinxtra site id is already existing.";
		// array_push($messages, $message);
	// }
	
	// if ($row_number > 0) {
		// $message = "ERROR : Thinxtra site id already existing.";
		// array_push($messages, $message);
	// }
